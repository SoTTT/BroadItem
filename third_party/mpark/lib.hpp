...
#ifndef BI_MPARK_LIB_HPP
#define BI_MPARK_LIB_HPP
...
namespace BroadItem { namespace detail { namespace mpark {
  namespace lib {
    ...
    inline namespace cpp14 {
...
#ifdef BI_MPARK_INTEGER_SEQUENCE
      ...
      // <functional>
#ifdef BI_MPARK_TRANSPARENT_OPERATORS
      using equal_to = std::equal_to<>;
#else
      struct equal_to {
        template <typename Lhs, typename Rhs>
        inline constexpr auto operator()(Lhs &&lhs, Rhs &&rhs) const
          BI_MPARK_RETURN(lib::forward<Lhs>(lhs) == lib::forward<Rhs>(rhs))
      };
#endif
      ...
      namespace detail {
        ...
        struct Invoke<true /* pmf */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            BI_MPARK_RETURN((lib::forward<Arg>(arg).*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<true /* pmf */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg, typename... Args>
          inline static constexpr auto invoke(R T::*pmf, Arg &&arg, Args &&... args)
            BI_MPARK_RETURN((lib::forward<Arg>(arg).get().*pmf)(lib::forward<Args>(args)...))
        };
        ...
        struct Invoke<false /* pmo */, 0 /* is_base_of */> {
          ...
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            BI_MPARK_RETURN(lib::forward<Arg>(arg).*pmo)
        };
        ...
        struct Invoke<false /* pmo */, 1 /* is_reference_wrapper */> {
          template <typename R, typename T, typename Arg>
          inline static constexpr auto invoke(R T::*pmo, Arg &&arg)
            BI_MPARK_RETURN(lib::forward<Arg>(arg).get().*pmo)
        };
...
#pragma warning(disable : 4100)
        ...
        inline constexpr auto invoke(F &&f, Args &&... args)
          BI_MPARK_RETURN(lib::forward<F>(f)(lib::forward<Args>(args)...))
#ifdef _MSC_VER
#pragma warning(pop)
#endif
      }  // namespace detail
      ...
      template <typename F, typename... Args>
      inline constexpr auto invoke(F &&f, Args &&... args)
        BI_MPARK_RETURN(detail::invoke(lib::forward<F>(f),
                                    lib::forward<Args>(args)...))
      ...
      // <memory>
#ifdef BI_MPARK_BUILTIN_ADDRESSOF
      template <typename T>
...
#ifdef BI_MPARK_TYPE_PACK_ELEMENT
...
#ifdef BI_MPARK_TRIVIALITY_TYPE_TRAITS
...
#undef BI_MPARK_RETURN

#endif  // BI_MPARK_LIB_HPP
