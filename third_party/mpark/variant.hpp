...
#ifndef BI_MPARK_VARIANT_HPP
#define BI_MPARK_VARIANT_HPP
...
#ifdef BI_MPARK_RETURN_TYPE_DEDUCTION
...
#ifdef BI_MPARK_EXCEPTIONS
    throw bad_variant_access{};
#else
    std::terminate();
    BI_MPARK_BUILTIN_UNREACHABLE;
#endif
  }
...
#ifdef BI_MPARK_CPP14_CONSTEXPR
...
#if defined(BI_MPARK_CPP14_CONSTEXPR) && !defined(_MSC_VER)
#define BI_MPARK_VARIANT_SWITCH_VISIT
#endif
      ...
      struct base {
...
#ifdef BI_MPARK_VARIANT_SWITCH_VISIT
        ...
        struct dispatcher<false, R, ITs...> {
          ...
          BI_MPARK_ALWAYS_INLINE static constexpr R dispatch(
              F &&, typename ITs::type &&..., Vs &&...) {
            BI_MPARK_BUILTIN_UNREACHABLE;
          }

          template <std::size_t I, typename F, typename... Vs>
          BI_MPARK_ALWAYS_INLINE static constexpr R dispatch_case(F &&, Vs &&...) {
            BI_MPARK_BUILTIN_UNREACHABLE;
          }

          template <std::size_t B, typename F, typename... Vs>
          BI_MPARK_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t,
                                                             F &&,
                                                             Vs &&...) {
            BI_MPARK_BUILTIN_UNREACHABLE;
          }
...
#define BI_MPARK_DEFAULT(I)                                                      \
  dispatcher<(I < lib::decay_t<V>::size()), R, ITs...>::template dispatch<I>( \
      ...
      lib::forward<Vs>(vs)...)
            ...
            switch (v.index()) {
              case B + 0: return BI_MPARK_DISPATCH(B + 0);
              case B + 1: return BI_MPARK_DISPATCH(B + 1);
              case B + 2: return BI_MPARK_DISPATCH(B + 2);
              case B + 3: return BI_MPARK_DISPATCH(B + 3);
              case B + 4: return BI_MPARK_DISPATCH(B + 4);
              case B + 5: return BI_MPARK_DISPATCH(B + 5);
              case B + 6: return BI_MPARK_DISPATCH(B + 6);
              case B + 7: return BI_MPARK_DISPATCH(B + 7);
              case B + 8: return BI_MPARK_DISPATCH(B + 8);
              case B + 9: return BI_MPARK_DISPATCH(B + 9);
              case B + 10: return BI_MPARK_DISPATCH(B + 10);
              case B + 11: return BI_MPARK_DISPATCH(B + 11);
              case B + 12: return BI_MPARK_DISPATCH(B + 12);
              case B + 13: return BI_MPARK_DISPATCH(B + 13);
              case B + 14: return BI_MPARK_DISPATCH(B + 14);
              case B + 15: return BI_MPARK_DISPATCH(B + 15);
              case B + 16: return BI_MPARK_DISPATCH(B + 16);
              case B + 17: return BI_MPARK_DISPATCH(B + 17);
              case B + 18: return BI_MPARK_DISPATCH(B + 18);
              case B + 19: return BI_MPARK_DISPATCH(B + 19);
              case B + 20: return BI_MPARK_DISPATCH(B + 20);
              case B + 21: return BI_MPARK_DISPATCH(B + 21);
              case B + 22: return BI_MPARK_DISPATCH(B + 22);
              case B + 23: return BI_MPARK_DISPATCH(B + 23);
              case B + 24: return BI_MPARK_DISPATCH(B + 24);
              case B + 25: return BI_MPARK_DISPATCH(B + 25);
              case B + 26: return BI_MPARK_DISPATCH(B + 26);
              case B + 27: return BI_MPARK_DISPATCH(B + 27);
              case B + 28: return BI_MPARK_DISPATCH(B + 28);
              case B + 29: return BI_MPARK_DISPATCH(B + 29);
              case B + 30: return BI_MPARK_DISPATCH(B + 30);
              case B + 31: return BI_MPARK_DISPATCH(B + 31);
              default: return BI_MPARK_DEFAULT(B + 32);
            }

#undef BI_MPARK_DEFAULT
#undef BI_MPARK_DISPATCH
          }

          template <std::size_t I, typename F, typename... Vs>
          BI_MPARK_ALWAYS_INLINE static constexpr R dispatch_case(F &&f,
                                                               Vs &&... vs) {
            using Expected = R;
          ...
          template <std::size_t B, typename F, typename V, typename... Vs>
          BI_MPARK_ALWAYS_INLINE static constexpr R dispatch_at(std::size_t index,
                                                             F &&f,
                                                             V &&v,
                                                             Vs &&... vs) {
...
#define BI_MPARK_DEFAULT(I)                                                 \
  dispatcher<(I < lib::decay_t<V>::size()), R>::template dispatch_at<I>( \
      index, lib::forward<F>(f), lib::forward<V>(v), lib::forward<Vs>(vs)...)
            ...
            switch (index) {
              case B + 0: return BI_MPARK_DISPATCH_AT(B + 0);
              case B + 1: return BI_MPARK_DISPATCH_AT(B + 1);
              case B + 2: return BI_MPARK_DISPATCH_AT(B + 2);
              case B + 3: return BI_MPARK_DISPATCH_AT(B + 3);
              case B + 4: return BI_MPARK_DISPATCH_AT(B + 4);
              case B + 5: return BI_MPARK_DISPATCH_AT(B + 5);
              case B + 6: return BI_MPARK_DISPATCH_AT(B + 6);
              case B + 7: return BI_MPARK_DISPATCH_AT(B + 7);
              case B + 8: return BI_MPARK_DISPATCH_AT(B + 8);
              case B + 9: return BI_MPARK_DISPATCH_AT(B + 9);
              case B + 10: return BI_MPARK_DISPATCH_AT(B + 10);
              case B + 11: return BI_MPARK_DISPATCH_AT(B + 11);
              case B + 12: return BI_MPARK_DISPATCH_AT(B + 12);
              case B + 13: return BI_MPARK_DISPATCH_AT(B + 13);
              case B + 14: return BI_MPARK_DISPATCH_AT(B + 14);
              case B + 15: return BI_MPARK_DISPATCH_AT(B + 15);
              case B + 16: return BI_MPARK_DISPATCH_AT(B + 16);
              case B + 17: return BI_MPARK_DISPATCH_AT(B + 17);
              case B + 18: return BI_MPARK_DISPATCH_AT(B + 18);
              case B + 19: return BI_MPARK_DISPATCH_AT(B + 19);
              case B + 20: return BI_MPARK_DISPATCH_AT(B + 20);
              case B + 21: return BI_MPARK_DISPATCH_AT(B + 21);
              case B + 22: return BI_MPARK_DISPATCH_AT(B + 22);
              case B + 23: return BI_MPARK_DISPATCH_AT(B + 23);
              case B + 24: return BI_MPARK_DISPATCH_AT(B + 24);
              case B + 25: return BI_MPARK_DISPATCH_AT(B + 25);
              case B + 26: return BI_MPARK_DISPATCH_AT(B + 26);
              case B + 27: return BI_MPARK_DISPATCH_AT(B + 27);
              case B + 28: return BI_MPARK_DISPATCH_AT(B + 28);
              case B + 29: return BI_MPARK_DISPATCH_AT(B + 29);
              case B + 30: return BI_MPARK_DISPATCH_AT(B + 30);
              case B + 31: return BI_MPARK_DISPATCH_AT(B + 31);
              default: return BI_MPARK_DEFAULT(B + 32);
            }

#undef BI_MPARK_DEFAULT
#undef BI_MPARK_DISPATCH_AT
          }
        };
#else
        template <typename T>
...
#if !defined(BI_MPARK_VARIANT_SWITCH_VISIT) && \
...
#define BI_MPARK_VARIANT_RECURSIVE_UNION(destructible_trait, destructor)      \
  ...
  union recursive_union<destructible_trait, Index, T, Ts...> {             \
    ...
    BI_MPARK_VARIANT_RECURSIVE_UNION(Trait::TriviallyAvailable,
                                  ~recursive_union() = default;);
    BI_MPARK_VARIANT_RECURSIVE_UNION(Trait::Available,
                                  ~recursive_union() {});
    BI_MPARK_VARIANT_RECURSIVE_UNION(Trait::Unavailable,
                                  ~recursive_union() = delete;);

#undef BI_MPARK_VARIANT_RECURSIVE_UNION
...
#define BI_MPARK_INHERITING_CTOR(type, base) using base::base;
#else
#define BI_MPARK_INHERITING_CTOR(type, base)         \
  template <typename... Args>                     \
...
#define BI_MPARK_VARIANT_DESTRUCTOR(destructible_trait, definition, destroy) \
  template <typename... Ts>                                               \
  class destructor<traits<Ts...>, destructible_trait>                     \
    ...
    using super = base<destructible_trait, Ts...>;                        \
                                                                          \
    public:                                                               \
    BI_MPARK_INHERITING_CTOR(destructor, super)                              \
...
#undef BI_MPARK_VARIANT_DESTRUCTOR
    ...
    class constructor : public destructor<Traits> {
      ...
      public:
      BI_MPARK_INHERITING_CTOR(constructor, super)
      using super::operator=;

      protected:
#ifndef BI_MPARK_GENERIC_LAMBDAS
      struct ctor {
      ...
      inline static void generic_construct(constructor &lhs, Rhs &&rhs) {
        ...
        if (!rhs.valueless_by_exception()) {
          visitation::alt::visit_alt_at(
              rhs.index(),
#ifdef BI_MPARK_GENERIC_LAMBDAS
...
#define BI_MPARK_VARIANT_MOVE_CONSTRUCTOR(move_constructible_trait, definition) \
  template <typename... Ts>                                                  \
  class move_constructor<traits<Ts...>, move_constructible_trait>            \
    ...
    using super = constructor<traits<Ts...>>;                                \
                                                                             \
    public:                                                                  \
    BI_MPARK_INHERITING_CTOR(move_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    ...
    BI_MPARK_VARIANT_MOVE_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#undef BI_MPARK_VARIANT_MOVE_CONSTRUCTOR

    template <typename Traits, Trait = Traits::copy_constructible_trait>
    class copy_constructor;

#define BI_MPARK_VARIANT_COPY_CONSTRUCTOR(copy_constructible_trait, definition) \
  template <typename... Ts>                                                  \
  class copy_constructor<traits<Ts...>, copy_constructible_trait>            \
    ...
    using super = move_constructor<traits<Ts...>>;                           \
                                                                             \
    public:                                                                  \
    BI_MPARK_INHERITING_CTOR(copy_constructor, super)                           \
    using super::operator=;                                                  \
                                                                             \
    definition                                                               \
    ...
    BI_MPARK_VARIANT_COPY_CONSTRUCTOR(
        Trait::TriviallyAvailable,
...
#undef BI_MPARK_VARIANT_COPY_CONSTRUCTOR
    ...
    class assignment : public copy_constructor<Traits> {
      ...
      public:
      BI_MPARK_INHERITING_CTOR(assignment, super)
      using super::operator=;
...
#define BI_MPARK_VARIANT_MOVE_ASSIGNMENT(move_assignable_trait, definition) \
  template <typename... Ts>                                              \
  class move_assignment<traits<Ts...>, move_assignable_trait>            \
    ...
    using super = assignment<traits<Ts...>>;                             \
                                                                         \
    public:                                                              \
    BI_MPARK_INHERITING_CTOR(move_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    BI_MPARK_VARIANT_MOVE_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#undef BI_MPARK_VARIANT_MOVE_ASSIGNMENT

    template <typename Traits, Trait = Traits::copy_assignable_trait>
    class copy_assignment;

#define BI_MPARK_VARIANT_COPY_ASSIGNMENT(copy_assignable_trait, definition) \
  template <typename... Ts>                                              \
  class copy_assignment<traits<Ts...>, copy_assignable_trait>            \
    ...
    using super = move_assignment<traits<Ts...>>;                        \
                                                                         \
    public:                                                              \
    BI_MPARK_INHERITING_CTOR(copy_assignment, super)                        \
    using super::operator=;                                              \
                                                                         \
    ...
    BI_MPARK_VARIANT_COPY_ASSIGNMENT(
        Trait::TriviallyAvailable,
...
#undef BI_MPARK_VARIANT_COPY_ASSIGNMENT
    ...
    class impl : public copy_assignment<traits<Ts...>> {
      ...
      public:
      BI_MPARK_INHERITING_CTOR(impl, super)
      using super::operator=;
...
#undef BI_MPARK_INHERITING_CTOR
...
namespace std {
  ...
  template <typename... Ts>
  struct hash<BroadItem::detail::mpark::detail::enabled_type<
      BroadItem::detail::mpark::variant<Ts...>,
      BroadItem::detail::mpark::lib::enable_if_t<BroadItem::detail::mpark::lib::all<BroadItem::detail::mpark::detail::hash::is_enabled<
          BroadItem::detail::mpark::lib::remove_const_t<Ts>>()...>::value>>> {
    using argument_type = BroadItem::detail::mpark::variant<Ts...>;
    using result_type = std::size_t;

    inline result_type operator()(const argument_type &v) const {
      using BroadItem::detail::mpark::detail::visitation::variant;
      std::size_t result =
...
#ifdef BI_MPARK_GENERIC_LAMBDAS
                    [](const auto &alt) {
                      using alt_type = BroadItem::detail::mpark::lib::decay_t<decltype(alt)>;
                      using value_type = BroadItem::detail::mpark::lib::remove_const_t<
    ...
    struct hasher {
      ...
      inline std::size_t operator()(const Alt &alt) const {
        using alt_type = BroadItem::detail::mpark::lib::decay_t<Alt>;
        using value_type =
            BroadItem::detail::mpark::lib::remove_const_t<typename alt_type::value_type>;
        return hash<value_type>{}(alt.value);
      }
    };
#endif
  ...
  template <>
  struct hash<BroadItem::detail::mpark::monostate> {
    using argument_type = BroadItem::detail::mpark::monostate;
    using result_type = std::size_t;
